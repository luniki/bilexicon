...
ActiveRecord::Schema.define(:version => 20090908090651) do
  ...
  create_table "lemmata", :force => true do |t|
    ...
    t.boolean  "reflexive_verb1"
    t.boolean  "regular_verb1"
    t.boolean  "irregular_verb1"
    t.boolean  "transitive_verb1"
    t.boolean  "intransitive_verb1"
    ...
    t.boolean  "reflexive_verb2"
    t.boolean  "regular_verb2"
    t.boolean  "irregular_verb2"
    t.boolean  "transitive_verb2"
    t.boolean  "intransitive_verb2"
