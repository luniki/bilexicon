...
describe LemmataController do
  describe "route generation" do
    it "should map #index" do
      route_for(:controller => "lemmata", :action => "index").should == "/lemmata"
    end
  
    it "should map #new" do
      route_for(:controller => "lemmata", :action => "new").should == "/lemmata/new"
    end
    ...
    it "should map #update" do
      route_for(:controller => "lemmata", :action => "update", :id => 1).should == "/lemmata/1"
    end
  
    it "should map #destroy" do
      route_for(:controller => "lemmata", :action => "destroy", :id => 1).should == "/lemmata/1"
    end
  end

  describe "route recognition" do
    it "should generate params for #index" do
      params_from(:get, "/lemmata").should == {:controller => "lemmata", :action => "index"}
    end
