...
describe ExamplesController do
  ...
  describe "responding to GET index" do
    ...
    describe "with mime type of xml" do
      ...
      it "should render all examples as xml" do
        request.env["HTTP_ACCEPT"] = "application/xml"
        Example.should_receive(:find).with(:all).and_return(examples = mock("Array of Examples"))
        examples.should_receive(:to_xml).and_return("generated XML")
        get :index
  ...
  describe "responding to GET show" do
    ...
    describe "with mime type of xml" do
      ...
      it "should render the requested example as xml" do
        request.env["HTTP_ACCEPT"] = "application/xml"
        Example.should_receive(:find).with("37").and_return(mock_example)
        mock_example.should_receive(:to_xml).and_return("generated XML")
        get :show, :id => "37"
        response.body.should == "generated XML"
      end
